...
export default function ProductDetail() {
   ...
   <>
    ...
    <div className='flex gap-[30px] px-24 mb-10'>
            ...
            <div className='flex flex-col gap-[20px]'>
              ...
              {product.stock > 0 ? (
                <div>
                  <Button type="button" className="inline-flex items-center justify-center gap-2 p-4 bg-[#E63946] text-center hover:bg-[#D32F2F] text-white active:bg-[#B71C1C] mt-[28px]">
  ...
  <span>Add to cart</span>
            ...
            <p><span className='font-medium'>Author:</span> {product.author ?? 'No author information.'}</p>
            ...
            <p><span className='font-medium'>Vol:</span> {product.vol ?? 'No volume information.'}</p>
